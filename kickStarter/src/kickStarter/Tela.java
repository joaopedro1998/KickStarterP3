...
public class Tela {
	...
	void mensagem(UsuarioPadrao usuarioLogado,UsuarioPadrao usuarioAuxiliar){
	...
	public void historicoDoacao(UsuarioPadrao usuario) {
		if(usuario.getDoacoes() == null) {
			System.out.println("Voce ainda nao fez sua primeira doacao");
		}
	...
	public void historicoProjeto(UsuarioPadrao usuario) {
		if(usuario.getProjetosCriados() == null) {
			System.out.println("Voce ainda nao criou nenhum projeto");
		}
		else
			System.out.println("Projeto(s) criado(s):");
		for(Projeto p: usuario.getProjetosCriados()) {
